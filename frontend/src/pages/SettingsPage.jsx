...
const SettingsPage = () => {
  ...
  return (
    <div className='mx-auto px-4 pt-20 max-w-5xl container space-y-6'>
      {/* Theme Selector */}
      ...
      <div className='grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2'>
        {THEMES.map(t => (
          <button
            ...
            onClick={() => setTheme(t)}
          >
            {/* Wrap preview in a data-theme container */}
            <div data-theme={t} className='relative rounded-md w-full h-8 overflow-hidden border'>
      ...
      {/* Wrap entire preview in selected theme */}
      <div data-theme={theme} className='bg-base-100 shadow-lg border border-base-300 rounded-xl overflow-hidden'>
            ...
            <div className='bg-base-100 shadow-sm rounded-xl overflow-hidden'>
              ...
              <div className='bg-base-100 p-4 border-t border-base-300'>
                <div className='flex gap-2'>
                  <input type='text' className='flex-1 input-bordered h-10 text-sm input' placeholder='Type a message...' value='This is a preview' readOnly />
                  <button className='h-10 min-h-0 btn btn-primary'><Send size={18} /></button>
                </div>
              </div>
